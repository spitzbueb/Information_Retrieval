...
public class Searcher {
		...
		public static void search(String indexDir, String q) throws IOException, ParseException
		{
			...
			MultiFieldQueryParser parser = new MultiFieldQueryParser(Version.LUCENE_30,new String[]{"filename","Künstler","Titel","Album","Jahr"},new StandardAnalyzer(Version.LUCENE_30));
